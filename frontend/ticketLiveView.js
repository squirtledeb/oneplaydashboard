...
${formResponses || userTicketHistory.length > 0 ? `
          <div class="w-1/3 mb-6 border rounded-lg p-4 bg-blue-50 text-sm text-gray-700 overflow-auto max-h-[calc(100vh-150px)]">
            ${formResponses ? `
